...
class EventsController extends CodedItemsController
{
    ...
    private function review($reviewerNumber, $eventId) {
            ...
            if (!$result[0]) {
                ...
                $this->Review->save($this->data, array('fieldList' => 
                    array('event_id', 'reviewer_id', 
                          ...
                          'afib_encounter_flag', 
                          'afib_history_flag',
                          'aflutter_encounter_flag', 
                          'aflutter_history_flag',
                          'af_timing', 
                          'assoc_coronary_flag',
                          'assoc_mi_flag',
                          'assoc_hf_flag',
                          ...
                          'assoc_copd_flag',
                          'assoc_stroke_flag',
                          'assoc_infection_flag',
                          'assoc_thoracic_flag',
                          'assoc_pvd_flag',
                          'assoc_surgery_flag',
                          'assoc_none_flag',
                          'assoc_coronary_angina_flag',
                          'assoc_coronary_cabg_flag',
                          'assoc_mi_30_flag',
                          'assoc_mi_gt30_flag',
                          'assoc_mi_unknown_flag',
                          'assoc_hf_exacerbation_flag',
                          'assoc_vhd_surgery_flag',
                          'assoc_vhd_disease_flag',
                          'assoc_copd_exacerbation_flag',
                          'assoc_stroke_current_flag',
                          'assoc_infection_sepsis_flag',
                          'assoc_infection_bacteremia_flag',
                          'assoc_infection_pneumonia_flag',
                          'assoc_infection_other_flag',
                          'assoc_infection_other',
                          'assoc_thoracic_malignancy_flag',
                          'assoc_thoracic_mass_flag',
                          'assoc_thoracic_pericarditis_flag',
                          'assoc_thoracic_ild_flag',
                          'assoc_thoracic_ph_flag',
                          'assoc_thoracic_other_flag',
                          'assoc_thoracic_other',
                          'tobacco', 
                          'ha_flag', 
                          'ha_intox_flag',
                          'sub_other_flag', 
                          'sub_other_marijuana_flag', 
                          'sub_other_meth_flag', 
                          'sub_other_meth_intox_flag', 
                          'sub_other_cocaine_flag', 
                          'sub_other_cocaine_intox_flag', 
                          'sub_other_opiate_flag', 
                          'sub_other_opiate_intox_flag', 
                          'sub_other_unspecified_flag', 
                          'af_secondary_flag', 
                          'secondary_infection_flag', 
                          'secondary_alcohol_flag', 
                          'secondary_thoracic_flag', 
                          'secondary_postop_flag', 
                          'secondary_other_flag', 
                          'secondary_other', 
                          'echo_flag', 
                          'echo_ef_percent', 
                          'echo_ef_text', 
                          ...
                          'echo_lvh_flag', 
                          'echo_lve_flag', 
                          'echo_lae_dimension_cm', 
                          'echo_lae_dimension_text', 
                          'echo_lae_volume', 
                          'echo_rv_flag', 
                          'echo_elevatedpressure_flag', 
                          'echo_valve_disease', 
                          'echo_other_flag', 
                          'echo_other', 
                          'af_type',
                          'antic_flag',
                          'antic_already_flag',
                          'antic_already_warfarin_flag',
                          'antic_already_noac_flag',
                          'antic_already_aspirin_flag',
                          'antic_already_other_flag',
                          'antic_already_unknown_flag',
                          'antic_prescribed_flag',
                          'antic_prescribed_warfarin_flag',
                          'antic_prescribed_noac_flag',
                          'antic_prescribed_aspirin_flag',
                          'antic_prescribed_other_flag',
                          'antic_prescribed_unknown_flag')));
        ...
        $this->set('timings', $this->Review->getTimings());
        $this->set('smokingUses', $this->Review->getSmokingUses());
        $this->set('afTypes', $this->Review->getAfTypes());
