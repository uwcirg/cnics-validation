...
function VTEEventDownload() {
  ...
  const handleDownload = async () => {
    ...
    try {
      const url = `${apiUrl}/api/events/download/${eventId}?study=vte`
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto' }}>
      <h1>📥 Download VTE Event Files</h1>
      ...
      <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
        ...
        <a
          href={`${apiUrl}/api/events/download/${eventId}?study=vte`}
          target="_blank"
...
export default VTEEventDownload
