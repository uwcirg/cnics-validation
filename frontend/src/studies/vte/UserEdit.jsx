  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit">Update VTE User</button>
      </form>
      {status === 'saved' && <p>VTE user updated.</p>}
      {status === 'error' && <p>Failed to update VTE user.</p>}
    </div>
  )
}

export default VTEUserEdit
