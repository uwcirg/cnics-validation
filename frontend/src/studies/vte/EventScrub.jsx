    ...
    <div>
      <div className="infobox" style={{ width: '300px', fontSize: '.95em' }}>
        ...
        <div style={{ marginTop: '8px' }}>
          View as:{' '}
          <a href={`${apiUrl}/files/CNICS VTE event scrubbing protocol.doc`} download>.doc</a>
          {' | '}
          <a href={`${apiUrl}/files/CNICS VTE event scrubbing protocol.pdf`} target="_blank">.pdf</a>
        </div>
      </div>

      <h1>Upload scrubbed charts for VTE {eventId}</h1>
