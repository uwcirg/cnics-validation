    ...
    <div className="home-container">
      ...
      {eventId && (
        <div className="infobox">
          <div>Packet for VTE {eventId}</div>
      ...
      <div className="infobox">
        <h3>VTE Review packets should contain:</h3>
        <ol>
          <li>Physician's notes closest to potential VTE event date</li>
          <li>Outpatient hematology/oncology consultations</li>
          <li>In-patient hematology/oncology notes or consults</li>
          <li>Imaging studies (ultrasound, CT, V/Q scan)</li>
          <li>Laboratory evidence (D-dimer, coagulation studies)</li>
          <li>Related procedure and diagnostic test results</li>
          <li>Anticoagulation treatment records</li>
          <li>
        ...
        <div>
          ...
          |{' '}
          <a
            href="/files/CNICS VTE Review packet assembly instructions.pdf"
            target="_blank"
          >
            .pdf
          </a>
