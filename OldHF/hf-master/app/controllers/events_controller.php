...
class EventsController extends CodedItemsController
{
    ...
    private function review($reviewerNumber, $eventId) {
            ...
            if (!$result[0]) {
                ...
                $this->Review->save($this->data, array('fieldList' => 
                    array('event_id', 'reviewer_id', 
                          ...
                          'nonischemic_flag',
                          'ni_valvular_flag',
                          'ni_infiltrative_flag',
                          'ni_im_flag',
                          'ni_obstructive_flag',
                          'ni_recreational_flag',
                          'ni_prescription_flag',
                          'ni_hypertensive_flag',
                          'ni_renal_flag',
                          'ni_cardiomyopathy_flag',
                          'ni_covid_flag',
                          'ni_sepsis_flag',
                          'ni_metabolic_flag',
                          'ni_pd_flag',
                          'ni_hypertrophic_flag',
                          'ni_other_flag',
                          'ni_other',
                          'unknown_flag',
                          'presentation',
        ...
        $this->set('congestions', $this->Review->getCongestions());
        $this->set('lvefs', $this->Review->getLvefs());
        $this->set('labs', $this->Review->getLabs());
        $this->set('hfTypes', $this->Review->getHfTypes());
        $this->set('classifications', $this->Review->getClassifications());
        $this->set('presentations', $this->Review->getPresentations());
